    ...
    <main className="relative min-h-screen overflow-hidden bg-space text-foreground">
      ...
      <header className="relative z-30 flex items-center justify-between px-6 py-5 sm:px-10">
        ...
        <nav className="flex items-center gap-2 text-xs sm:text-sm">
          <Link
            to="/resources"
            className="rounded-full border border-border/60 bg-card/40 px-4 py-2 font-semibold text-foreground/80 backdrop-blur transition hover:border-primary/50 hover:bg-card/70 hover:text-primary"
          >
            Resources
          </Link>
        </nav>
